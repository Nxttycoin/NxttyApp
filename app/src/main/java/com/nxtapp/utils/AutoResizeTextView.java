...
//    public static final float MIN_TEXT_SIZE = 28;

    // Minimum text size for this text view
//    public static final float MAX_TEXT_SIZE = 55;
    
    private float MAX_TEXT_SIZE = getResources().getDimensionPixelSize(R.dimen.mid_text_size);
    
    private float MIN_TEXT_SIZE = getResources().getDimensionPixelSize(R.dimen.auto_fit_text_size);
