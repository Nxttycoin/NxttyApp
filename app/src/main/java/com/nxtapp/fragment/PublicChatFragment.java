...
import com.nxtapp.fragment.AddGroup.CallBackCLick;
...
public class PublicChatFragment extends BaseListFragment implements CallBackCLick
{
   ...
   // LinearLayout lnAddChat, lnSettings;
	...
	View view = inflater.inflate(R.layout.public_chat, null, false);
