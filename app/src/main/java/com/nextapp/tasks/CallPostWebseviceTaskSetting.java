...
public class CallPostWebseviceTaskSetting extends AsyncTask<Void, Void, String>
{
    ...
    public CallPostWebseviceTaskSetting(Context context, boolean showPDialog, String subUrl, List<NameValuePair> nameValuePairs)
    {
    ...
    public CallPostWebseviceTaskSetting(Context context, boolean showPDialog, String subUrl, MultipartEntity entityBuilder)
    {
