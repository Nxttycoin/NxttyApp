...
import com.nxtty.lib.imagezoom.ImageViewTouchBase.OnBitmapChangedListener;
...
public class ImageViewTouch extends ImageViewTouchBase
{
	...
	void onBitmapLongClick( Bitmap bitmap );
};


private OnBitmapLongClickListener mListener;


public void onBitmapLongClick( OnBitmapLongClickListener listener ) {
	mListener = listener;
}
	 ...
	 try
	{
		  ...
		  if( mListener != null ) {
			mListener.onBitmapLongClick( getDisplayBitmap().getBitmap() );
		}
